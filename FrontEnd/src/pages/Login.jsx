...
const loginSchema = z.object({
  ...
  password: z.string().min(1, "Password is required"), // Changed min(8) to min(1) for login typically, but kept simple
});
...
function Login() {
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-gray-900 via-gray-800 to-gray-950">
      {/* Left Panel - Brand Section (Identical visual style to Signup) */}
      <div className="hidden lg:flex w-1/2 flex-col items-center justify-center p-8 lg:p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-2xl space-y-8">
          <div className="space-y-4">
            ...
            {/* Contextual Change: Text tailored for Returning Users */}
            ...
            <p className="text-gray-300 text-lg mt-4 max-w-2xl">
              Pick up right where you left off. Continue solving challenges, 
              building your streak, and mastering new algorithms today.
            </p>
          </div>

          {/* Features Grid - Kept mainly consistent for visual unity */}
          <div className="grid grid-cols-2 gap-4 mt-6">
            ...
            <div className="bg-gray-800/40 backdrop-blur-sm rounded-xl p-4 border border-gray-700/50">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-xl font-bold text-white">Community</div>
                  <div className="text-gray-400 text-sm">Is Waiting</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800/40 backdrop-blur-sm rounded-xl p-4 border border-gray-700/50">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-gray-400 text-sm">Your Skills</div>
                </div>
              </div>
            </div>
          </div>
